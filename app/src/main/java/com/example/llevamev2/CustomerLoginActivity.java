...
public class CustomerLoginActivity extends AppCompatActivity {
    ...
    private EditText mEmailCustomerEditText,mPasswordDriverEditText3 ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailCustomerEditText = (EditText) findViewById(R.id.emailDrivererEditText);
        ...
        mSinginDrivererButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                final String email = mEmailCustomerEditText.getText().toString();
                final String password = mPasswordDriverEditText3.getText().toString();
                mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(CustomerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            Toast.makeText(CustomerLoginActivity.this, "singn up error", Toast.LENGTH_SHORT).show();
                        }else{
        ...
        mLoginDriverButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(CustomerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            Toast.makeText(CustomerLoginActivity.this, "longin in error", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
